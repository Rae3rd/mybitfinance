...
const AdminLayout: React.FC<AdminLayoutProps> = ({ children }) => {
  ...
  const navItems = [
    ...
    { name: 'Analytics', href: '/admin/analytics', icon: UserGroupIcon },
  ...
  const notifications = [
    ...
    { id: 2, message: 'Withdrawal request pending approval', time: '10 minutes ago', type: 'warning' },
    { id: 3, message: 'System update completed', time: '1 hour ago', type: 'success' },
    { id: 4, message: 'New support ticket opened', time: '3 hours ago', type: 'info' },
  ];
        ...
        <div className="h-full flex flex-col">
          <div className="flex items-center justify-between h-16 px-4 border-b border-navy-700">
            <Link href="/admin" className="flex items-center space-x-1 group">
              ...
              >
                <ShieldCheckIcon className="h-6 w-6 text-emerald-400 group-hover:text-emerald-300 transition-colors" />
              </motion.div>
              <div>
                      ...
                      >
                        <div className="py-1" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
                          <div className="px-4 py-3 border-b border-gray-100 bg-gradient-to-r from-navy-50 to-gray-50">
                            ...
                            <p className="text-xs text-gray-500 mt-1">Admin alerts and updates</p>
                          </div>
                          ...
                          <div className="border-t border-gray-100 px-4 py-3 bg-gradient-to-r from-navy-50 to-gray-50">
                            <Link href="/admin/notifications" className="text-xs font-medium text-emerald-600 hover:text-emerald-500 flex items-center justify-center">
                      ...
                      >
                        <div className="py-1">
                          <div className="px-4 py-3 border-b border-gray-100 bg-gradient-to-r from-navy-50 to-gray-50">
                            ...
                            <p className="text-xs text-gray-500 truncate mt-1">Administrator</p>
                          </div>
                          ...
                          <Link href="/sign-out" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 border-t border-gray-100">
                            Sign out
                          </Link>
                        </div>
                      </motion.div>
